...
public class Xnat[HERE_SCHEMANAME]Plugin {
    ...
    @Bean
    public CompositeDicomObjectIdentifier projectXnat02Identifier(final NamedParameterJdbcTemplate [HERE_SCHEMANAME_LOWER]) {
        return new FixedProjectSubjectDicomObjectIdentifier([HERE_SCHEMANAME_LOWER], "XNAT_02", "XNAT_02_01");
    }
